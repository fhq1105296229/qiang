...
import org.jfree.data.general.DatasetUtilities;import demo.jfreechart.Piechart;
...
public class CreateJFreeChart {
	...
	public static void main(String args[]){
		...
		try {
			FileOutputStream fos = new FileOutputStream("e:/abcd.png");
			ChartUtilities.writeChartAsPNG(fos, new CreateJFreeChart().makeLineAndShapeChart("各地汽车销量", "城市", "销量", dataset),120, 120);
		} catch (IOException e) {
